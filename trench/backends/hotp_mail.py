...
from trench.backends.hotp_base import AbstractHOTPMessageDispatcher
...
class HOTPSendMailMessageDispatcher(AbstractHOTPMessageDispatcher):
    """HOTP-based email message dispatcher."""
    
    _KEY_MESSAGE = "message"
    _SUCCESS_DETAILS = _("Email message with HOTP MFA code has been sent.")
